    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-6">
        ...
        <p className="text-lg md:text-xl max-w-2xl mx-auto opacity-90 drop-shadow mb-6">
          Дома, бани и беседки из оцилиндрованного бревна и профилированного бруса в Свердловской области — тепло, надёжность и красота на десятилетия
        </p>
        ...
        <a href="mailto:drevgrad.dom2026@gmail.com" className="block mt-2 text-white text-base md:text-lg drop-shadow hover:text-amber-400 transition-colors duration-300">
